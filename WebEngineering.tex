...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Put message on user wall WSDM model]{Put message on user wall navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Answer message on user wall WSDM model]{Answer message on personal wall navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Delete message on user wall WSDM model]{Delete message on personal wall navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Send private message WSDM model]{Send private message navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Like a user WSDM model]{Like a user navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Manage liked list WSDM model]{Manage liked list navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Notify user of profile updates WSDM model]{Notify user of profile updates navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Send attention WSDM model]{Sent an attention to the user navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Block or report user WSDM model]{Block or report a user navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Log out WSDM model]{Log out of the system navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Terminate account WSDM model]{Terminate account navigational model.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Display personal information WSDM model]{Display personal information.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Display foreign information WSDM model]{Display foreign information.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Browse user profile WSDM model]{Browse user profile.}
\end{minipage}
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Send message to any user WSDM model]{Send message to any user.}
\end{minipage}
$\;$ \\ 
...
\noindent\begin{minipage}{\textwidth}
 ...
 \captionof{figure}[Block, disable and delete user account WSDM model]{Block, disable and delete user account.}
\end{minipage}
